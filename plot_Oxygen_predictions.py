...
with PdfPages('figs/plot_Oxygen_predictions.pdf') as pdf:
    ...
    ax.semilogx(0)
    ax.text(43, 0.685, r'OO/pp at 5.36 TeV', color='k', rotation=-0, fontsize=18)
    ax.text(43, 0.65, r'inclusive jets: $R_{ak_t}=0.4$, $|\eta_{\rm jet}|<2.1$', color='k', rotation=-0, fontsize=18)
    ax.text(43, 0.615, r'EPPS21 + NLO QCD + coherent energy loss', color='k', rotation=-0, fontsize=18)
    ...
    ax.fill_between(raa2.T[0], raa2.T[1], raa2.T[2], color='C0', label=r'OO: 30-100\%')
    ax.fill_between(raa2.T[0], raa2.T[3], raa2.T[4], color='C0', alpha=0.3)
    ax.text(33, -0.003, r'OO/pp at 5.36 TeV', color='k', rotation=-0, fontsize=18)
    ax.text(33, -0.006, r'inclusive jets: $R_{ak_t}=0.4$, $|\eta_{\rm jet}|<2.1$', color='k', rotation=-0, fontsize=18)
    ax.text(33, -0.009, r'EPPS21 + NLO QCD + coherent energy loss', color='k', rotation=-0, fontsize=18)
    ...
    ax.fill_between(raa2.T[0], raa2.T[3], raa2.T[4], color='C0', alpha=0.3)
    ax.semilogx(0)
    ax.text(12, 0.685, r'OO/pp at 5.36 TeV', color='k', rotation=-0, fontsize=16).set_zorder(102)
    ax.text(12, 0.65, r'inclusive charged hadrons: $|\eta_{\rm h^\pm}|<2.1$', color='k', rotation=-0, fontsize=16).set_zorder(102)
    ax.text(12, 0.615, r'EPPS21 + NLO QCD + coherent energy loss + NPC23', color='k', rotation=-0, fontsize=16).set_zorder(102)
    ...
    ax.fill_between(raa2.T[0], raa2.T[1], raa2.T[2], color='C0', label=r'OO: 30-100\%')
    ax.fill_between(raa2.T[0], raa2.T[3], raa2.T[4], color='C0', alpha=0.3)
    ax.text(11, -0.003, r'OO/pp at 5.36 TeV', color='k', rotation=-0, fontsize=16)
    ax.text(11, -0.006, r'inclusive charged hadrons: $|\eta_{\rm h^\pm}|<2.1$', color='k', rotation=-0, fontsize=16)
    ax.text(11, -0.009, r'EPPS21 + NLO QCD + coherent energy loss + NPC23', color='k', rotation=-0, fontsize=16)
    ax.legend(fontsize=18)
    ax.set_ylim(-0.01,0.03)
    ax.set_xlim(30,500)
    ax.set_xlabel(r'$p_T^{\rm jet}$ [GeV]', fontsize=20)
